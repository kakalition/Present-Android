...
internal object NotificationItemRepositoryImplTest : Spek({
    Feature("NotificationItem Repository") {

        lateinit var testCoroutineScheduler: TestCoroutineScheduler
        lateinit var coroutineDispatcher: TestDispatcher

        lateinit var dao: INotificationItemDao
        lateinit var mapper: NotificationItemEntityMapper
        lateinit var localDataSource: NotificationItemLocalDataSource
